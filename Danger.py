...
TOKEN = '7543520767:AAGaar6mqBcLr2fyluplIEjsX9HoSlUb8BQ'
    ...
    try:
        ...
        if not user_data or user_data['plan'] == 0:
            bot.send_message(chat_id, "*🚫 Access Denied!*\n"  # Access Denied message
                                       ...
                                       "*Contact the owner for assistance: @Naughtynimbuu .*", parse_mode='Markdown')  # Contact owner message
            return
...
def myinfo_command(message):
    ...
    if not user_data:
        ...
        response += "*Koi bhi problem ho to baap se baat kar: Naughtynimbuu * "  # Contact owner message
